...
The execution evidence below records the original audit at `821b0cd43d710c0f5f710cbece25257c5ae794fb`. The later [preservation review correction](metadata-linkage-preservation-review/README.md) separates its full historical 462-file claim from current frozen-data checks. It changes no findings or saved evidence. Strict audit reproduction belongs in that pinned snapshot; see the [replay instructions](../analysis/metadata-linkage-v1/README.md#historical-replay-at-the-recorded-snapshot).
